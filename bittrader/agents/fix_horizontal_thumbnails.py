#!/usr/bin/env python3
"""
🔧 Fix Horizontal Thumbnails - Ensure all thumbnails are 16:9 horizontal
"""
import requests
...
# Videos to fix (horizontal thumbnails with proper branding)
videos_to_fix = [
    {
...
def main():
    ...
    for i, v in enumerate(videos_to_fix):
        ...
        thumb_path = Path(f"/tmp/thumb_fixed_{v['id']}.jpg")
